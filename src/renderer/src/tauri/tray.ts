...
const TRAY_LABELS: Record<Locale, { show: string; insights: string; profile: string; language: string; theme: string; auto: string; light: string; dark: string; quit: string }> = {
  "zh-CN": { show: "显示窗口", insights: "使用统计", profile: "切换 Profile", language: "切换语言", theme: "切换主题", auto: "跟随系统", light: "浅色", dark: "深色", quit: "退出" },
  "zh-TW": { show: "顯示視窗", insights: "使用統計", profile: "切換 Profile", language: "切換語言", theme: "切換主題", auto: "跟隨系統", light: "淺色", dark: "深色", quit: "結束" },
  "en-US": { show: "Show Window", insights: "Usage Statistics", profile: "Switch Profile", language: "Language", theme: "Theme", auto: "System", light: "Light", dark: "Dark", quit: "Quit" },
  "ja-JP": { show: "ウィンドウを表示", insights: "利用統計", profile: "Profile 切替", language: "言語", theme: "テーマ", auto: "システム", light: "ライト", dark: "ダーク", quit: "終了" },
  "de-DE": { show: "Fenster anzeigen", insights: "Nutzungsstatistik", profile: "Profil wechseln", language: "Sprache", theme: "Thema", auto: "System", light: "Hell", dark: "Dunkel", quit: "Beenden" },
  "es-ES": { show: "Mostrar ventana", insights: "Uso y estadísticas", profile: "Cambiar perfil", language: "Idioma", theme: "Tema", auto: "Sistema", light: "Claro", dark: "Oscuro", quit: "Salir" },
};
