...
> **历史记录，2026-09-18 起归档。** 本文记录旧桌面与 CLI 0.38 阶段的工作，不再作为当前任务清单或执行指令。后续契约以 [2.0 原生文件契约](docs/kimi-code-2.0-contract.md) 为准，Web 重构状态以 [重构记录](docs/refactor-execution.md) 为准。下文测试数字、旧代码路径和待办仅代表历史时点。
